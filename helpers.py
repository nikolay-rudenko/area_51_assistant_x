...
def print_help():
    ...
    commands = [
        ...
        ['birthdays-in-period <days>', 'Show upcoming birthdays in the specified period.'],
        ...
        ['change_email <name> <new_email>', 'Change the email for a contact.'],
        ['change_address <name> <new_address>', 'Change the address for a contact.'],
        ['show_email <name>', 'Show the email for a contact.'],
        ['show_address <name>', 'Show the address for a contact.'],
